...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new VismaSignClient.DocumentInvitationStatus();
  });
  ...
  describe('DocumentInvitationStatus', function() {
    it('should create an instance of DocumentInvitationStatus', function() {
      // uncomment below and update the code to test DocumentInvitationStatus
      //var instane = new VismaSignClient.DocumentInvitationStatus();
      //expect(instance).to.be.a(VismaSignClient.DocumentInvitationStatus);
    });
