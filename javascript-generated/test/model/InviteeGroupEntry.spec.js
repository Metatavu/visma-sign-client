...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new VismaSignClient.InviteeGroupEntry();
  });
  ...
  describe('InviteeGroupEntry', function() {
    it('should create an instance of InviteeGroupEntry', function() {
      // uncomment below and update the code to test InviteeGroupEntry
      //var instane = new VismaSignClient.InviteeGroupEntry();
      //expect(instance).to.be.a(VismaSignClient.InviteeGroupEntry);
    });
