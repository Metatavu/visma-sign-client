...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new VismaSignClient.InternalServerError();
  });
  ...
  describe('InternalServerError', function() {
    it('should create an instance of InternalServerError', function() {
      ...
      //var instane = new VismaSignClient.InternalServerError();
      //expect(instance).to.be.a(VismaSignClient.InternalServerError);
    });
